...
The process to make a change to the list below is outlined in the [Administrative Working Group Documentation](../../../wg-administrative/github-ownership-access).  If the request is approved a member of the Administrative Working Group shall make a pull request to this file to update the above list.
...
All [maintainers](../../../charter#definitions) are granted "Write" permissions to all
